...
function_7465:
	...
	JP   SetupGameRegionPixAddrLUT
data_74C9:
	.db $20 			; player x position
	.db $90 			; player y position
	.db $06 			; ?
	.db $00 			; room number
	.db $F4 
	.db $01 
...
player_falling:
	...
	LD   A,(FrameCounter)			; only fire every 4 frames
	AND  %00000011
...
ActiveProjectiles:
	...
	.db $00 			; 6 - X velocity
	.db $06 			; 7
	.db $08 			; 8 - gets added to previous value
	.db $0C 			; 9
	.db 10 			; 0Ah - graphic set
	.db $02 			; 0Bh - 
	.db $44 			; 0Ch - Attribute 
	.db 12 			; 0Dh - total life
	.db $54 
	.db $97 
	.db $00 
	.db $01 
...
DrawMovingSpriteXOR:
	...
	LD   A,E
	CP   170
	JP   NC,label_A367			; E is >= 170
	LD   A,C
	CP   170
	JP   NC,label_A367			; C is >= 170
	LD   A,E
	CP   121
...
; the section below effectively multiplies by 192 because there are 4 48byte images in a moving sprite set
	...
	RRCA
	LD   (operand_A265+1),A			; OR in X coordinate
	LD   C,D			; put y in a
	...
	RRCA
	RRCA
	LD   (operand_A27E+1),A			; OR in X coordinate
	LD   C,D
...
data_FFE0:
	...
	.dw $07F1
	.dw $7C08
	.dw $C471			; push character address
	.dw $0147
	.dw $94AB
	.dw $0B17
data_FFF6:
